...
# ----------------- KERALA SCERT SYLLABUS (10TH, +1, +2 ONLY) -----------------
KERALA_CLASSES = [
    "Class 10 (SSLC)",
    "Plus One (+1 Science)",
    "Plus One (+1 Commerce)",
...
def init_db():
    with get_connection() as conn:
        ...
        if not c.fetchone():
            ...
            # കോളങ്ങളുടെ എണ്ണം 1 മാത്രം ആക്കി ശരിയാക്കിയ വരി
            c.execute('INSERT INTO notices (notice_text) VALUES (?)', 
                      ('Welcome to the official digital campus portal of GVHSS KUNIYA (SSLC, +1, +2).',))
...
def login_screen():
    ...
    with col:
        ...
        st.caption("Govt Vocational Higher Secondary School, Kuniya • Kasaragod (10th, +1, +2)")
        st.write("---")
...
# Class, Subject & Chapter Selection (10th, +1, +2 only)
